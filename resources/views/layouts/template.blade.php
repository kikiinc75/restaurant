...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('vendor/images/favicon.png')}}">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="{{asset('vendor/libs/flot/css/float-chart.css')}}" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="{{asset('vendor/css/style.min.css')}}" rel="stylesheet">
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{url('home')}}">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('vendor/images/logo-icon.png')}}" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{asset('vendor/images/logo-text.png')}}" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('vendor/images/users/1.jpg')}}" alt="user" class="rounded-circle" width="31"></a>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="ajax waves-effect waves-dark sidebar-link" id="menu-sale" href="{{url('transaction')}}" aria-expanded="false"><i class="mdi mdi-border-inside"></i><span class="hide-menu">Transaction</span></a></li>
    ...
    <script src="{{asset('vendor/libs/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('vendor/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{asset('vendor/extra-libs/sparkline/sparkline.js')}}"></script>
    <!--Wave Effects -->
    ...
    <!-- <script src="{{asset('vendor/js/pages/dashboards/dashboard1.js')}}"></script> -->
    <!-- Charts js Files -->
    <script src="{{asset('vendor/libs/flot/excanvas.js')}}"></script>
    <script src="{{asset('vendor/libs/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('vendor/libs/flot/jquery.flot.pie.js')}}"></script>
    <script src="{{asset('vendor/libs/flot/jquery.flot.time.js')}}"></script>
    <script src="{{asset('vendor/libs/flot/jquery.flot.stack.js')}}"></script>
